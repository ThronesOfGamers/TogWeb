    ...
    <div class="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        ...
        >
            ...
            >
                ...
                <img class="object-center object-cover rounded-full h-36 w-36 mb-8 -mt-20 mx-auto" src="{{ asset('storage/members/0hHFEs6chyTkrphbWNaVGVV7gKhuPs-metaMzMwNTgyMjIuanBn-.jpg') }}" alt="photo">
