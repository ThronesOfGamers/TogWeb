    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
        <div class="w-full rounded-lg p-12 flex flex-col justify-center items-center">
            ...
            <div class="mt-auto flex justify-between items-center w-full mt-5">
                <div>
                    <span class="bg-green-500 text-white rounded-full px-2 py-1 text-sm font-semibold">12/09/2012</span>
                </div>
                <div>
            ...
            <div class="mt-6 flex space-x-4">
                <a href="#" class="text-gray-600 hover:text-blue-600">twitter<i class="fab fa-twitter"></i></a>
                <a href="#" class="text-gray-600 hover:text-blue-600">insta<i class="fab fa-instagram"></i></a>
